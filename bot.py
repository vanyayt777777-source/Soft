...
BOT_TOKEN = os.getenv("BOT_TOKEN")  # Берется из переменных окружения
CRYPTO_BOT_TOKEN = os.getenv("CRYPTO_BOT_TOKEN", "545818:AAvQLMQHJbxqEou37HutdklFOJEO1agzhLp")
ADMIN_IDS = [int(id) for id in os.getenv("ADMIN_IDS", "8112176415,7973988177").split(",")]
CHANNEL_USERNAME = os.getenv("CHANNEL_USERNAME", "@TvistNFT")
DB_URL = os.getenv("DATABASE_URL", "postgresql://bothost_db_ed40420ef0b2:SteZisYQifIzWGcfFvsPwwiOd-2jsosCA54EVbTNpYs@node1.pghost.ru:32801/bothost_db_ed40420ef0b2")
USD_TO_RUB = float(os.getenv("USD_TO_RUB", "70.0"))
